...
A total of nine binary datasets are included in this initial resampling implementation experiment. Each dataset is a combination of one of the three failure types and one of the three normal types. The number of majority and minority instances along with the majority to minority ratio for each dataset are presented in Table \ref{table:binaryratio}. All nine binary sampling methods described in the previous subsections are applied to these datasets. Furthermore, every method and dataset combination is repeated ten times, yielding 90 cross validation error rates for each sampling method.
	...
	\begin{table}[h!]
		...
		\begin{tabular}{ | l | l | l | l | l | }
			\hline
			\multicolumn{1}{ | c | }{\textbf{Maj. Class}}
			& \multicolumn{1}{ | c | }{\textbf{Min. Class}}
			& \multicolumn{1}{ | c | }{\textbf{Maj. Instances}}
			& \multicolumn{1}{ | c | }{\textbf{Min. Instances}} 
			& \multicolumn{1}{ | c | }{\textbf{Maj. : Min. Ratio}}\\
			\hline
			Normal 1	 & Failure 1 & 233 & 90 & $2.6:1$\\
			Normal 1	 & Failure 2 & 233 & 19 & $12.3:1$\\
			Normal 1	 & Failure 3 & 233 & 90 & $2.6:1$\\
			Normal 2	 & Failure 1 & 252 & 90 & $2.8:1$\\
			Normal 2	 & Failure 2 & 252 & 19 & $13.7:1$\\
			Normal 2	 & Failure 3 & 252 & 90 & $2.8:1$\\
			Normal 3	 & Failure 1 & 230 & 90 & $2.6:1$\\
			Normal 3	 & Failure 2 & 230 & 19 & $12.1:1$\\
			Normal 3	 & Failure 3 & 230 & 90 & $2.6:1$\\
			\hline
		\end{tabular}
		\caption{Information on majority and minority classes, their number of instances, and the class ratios for the binary datasets} 
