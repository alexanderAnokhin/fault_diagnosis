...
\end{description}
	...
	After improvements and modifications final model consists of 15 standard ``$C$'' implementations of binary SVM classifier with parameter $C=20.65$. Kernel transformation is ANOVA RBF with a vector of parameters $\alpha=\left(\sigma=0.77, d=1.03\right)$. ``One Against One'' approach is used to deduce the winner class  
